<div class = "footer" data-role = "footer" data-id = "myfooter" data-position = "fixed" data-theme = "a">
	<div class = "controls" data-role = "controlgroup" data-type = "horizontal">
		<a href = "index.php" class = "ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-home" data-role = "button" data-icon = "home">Home</a>
		...
		<a href = "profile.php" class="ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-user" data-role = "button" data-icon = "phone">Me</a>
	</div>
</div>